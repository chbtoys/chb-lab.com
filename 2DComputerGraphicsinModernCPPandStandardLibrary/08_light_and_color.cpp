// Compile: clear && clang++ -std=c++20 08_light_and_color.cpp -o 08_light_and_color
...
int main()
{
	...
	std::cout << "Blended two images2." << std::endl;
	blended_two_images(blend1,blend2,width,height,0.2);
	std::cout << "Saving: '08_blended_two_images2.ppm'." << std::endl << std::endl;
	save_image(blend1,width,height,"08_blended_two_images2.ppm");

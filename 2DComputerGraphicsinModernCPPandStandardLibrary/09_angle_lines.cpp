// Compile: clear && clang++ -std=c++20 09_angle_lines.cpp -o 09_angle_lines
...
int main()
{
	...
	std::tuple<float,float,float> color=std::make_tuple(0.0,0.0,0.0);
	...
	save_image(image,width,height,"09_angle_lines.ppm");
